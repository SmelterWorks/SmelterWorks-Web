...
class PageContentTest extends TestCase
{
    ...
    public function test_home_page_uses_projects_section_without_marketing_lede(): void
    {
        $this->get(route('home'))
            ...
            ->assertSee('Hosting', false)
            ->assertSee('Coming soon', false)
            ->assertSee('Consumer friendly', false)
            ->assertSee('Unlimited slots', false)
            ->assertSee('One-click mods', false)
            ->assertSee('VS ModDB', false)
            ->assertSee('https://mods.vintagestory.at/', false)
            ->assertSee('File browser and editor', false)
            ->assertSee('Automatic and manual backups', false)
            ->assertSee('US and EU', false)
            ->assertSee('Limited availability when we open. First come, first served.', false)
            ->assertSee('VS =', false)
            ->assertSee('>Vintage Story<', false)
            ->assertSee(config('smelterworks.links.vintage_story'), false)
    ...
    public function test_mods_page_stays_mods_only(): void
    {
        $this->get(route('mods'))
            ...
            ->assertDontSee('Relic Launcher', false)
